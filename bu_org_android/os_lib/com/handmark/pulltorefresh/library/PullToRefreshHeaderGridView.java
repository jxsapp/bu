...
public class PullToRefreshHeaderGridView extends PullToRefreshAdapterViewBase<HeaderGridView> {
	...
	protected final HeaderGridView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			gv = new InternalHeaderGridViewSDK9(context, attrs);
		} else {
			gv = new InternalHeaderGridView(context, attrs);
		}
	...
	class InternalHeaderGridView extends HeaderGridView implements EmptyViewMethodAccessor {
	...
	@TargetApi(9)
	final class InternalHeaderGridViewSDK9 extends InternalHeaderGridView {

		public InternalHeaderGridViewSDK9(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
