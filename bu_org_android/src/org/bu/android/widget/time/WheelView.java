...
public class WheelView extends View {
	...
	private final int value_text_color = getContext().getResources().getColor(R.color.value_text_color);

	/** Items text color */
	private final int ITEMS_TEXT_COLOR = getContext().getResources().getColor(R.color.items_text_color);

	/** Top and bottom shadows colors */
	private final int[] SHADOWS_COLORS = new int[] { getContext().getResources().getColor(R.color.shadows_color_0), getContext().getResources().getColor(R.color.shadows_color_1),
			getContext().getResources().getColor(R.color.shadows_color_2) };
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, getContext().getResources().getColor(R.color.shadow_layer));
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.bu_time_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.bu_time_wheel_bg);
	}
