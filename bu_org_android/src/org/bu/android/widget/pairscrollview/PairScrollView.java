package org.bu.android.widget.pairscrollview;
...
public class PairScrollView extends ViewGroup {
	...
	private void fling(int velocity) {
		mScroller.fling(getScrollX(), getScrollY(), 0, velocity, 0, computeHorizontalScrollRange(), 0, computeVerticalScrollRange());
		ViewCompat.postInvalidateOnAnimation(this);
	}
