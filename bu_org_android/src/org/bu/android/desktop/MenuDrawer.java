...
public abstract class MenuDrawer extends ViewGroup {
	...
	public MenuDrawer(Activity activity, int dragMode) {
		this(activity);
	...
	protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
		...
		if (mDropShadowDrawable == null) {
			final int dropShadowColor = a.getColor(R.styleable.MenuDrawer_mdDropShadowColor, 0x00000000);
		...
		mMenuOverlay = new ColorDrawable(0x00000000);
