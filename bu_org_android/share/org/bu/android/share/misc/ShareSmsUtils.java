...
public class ShareSmsUtils {
	...
	public static final String SMS_SEND_ACTIOIN = "bu.org.android.share_SMS_SEND_ACTIOIN";
	public static final String SMS_DELIVERED_ACTIOIN = "bu.org.android.share_SMS_DELIVERED_ACTIOIN";

	private static Intent sentIntent = new Intent(SMS_SEND_ACTIOIN);
	private static Intent deliveryIntent = new Intent(SMS_DELIVERED_ACTIOIN);
	...
	public static void sendMessage(Context context, String number, String body) {
		...
		for (String text : texts) {
			ShareSmsUtils.natureSendSms(context, number, text);
		}
	}
